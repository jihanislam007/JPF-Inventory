...
<html lang="en">
  ...
  <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-light custom_White">
        <div class="navbar sky_blue">
          <img class="center" src="image/logo_JPF.png" width="80" height="40" alt="" loading="lazy">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link text-info text-uppercase " href="#">Dashboard <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-uppercase" href="#">Stock</a>
            </li>
